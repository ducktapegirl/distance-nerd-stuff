...
AUDIT = [
    ...
    ("journey-run", 19, "adapt", "Numbers beside the CONUS map, coast only, clipped to its box. The milepost strip is the alternative below; the map was chosen 2026-09-13."),
    ("journey-bike", 19, "adapt", "Same treatment, to match the run."),
    ...
    ("mosaic", 37, "adapt", "32 routes would be 25 px squiggles, so the audit dropped it; reinstated 2026-09-13 as a 2×6 at 42 px."),
