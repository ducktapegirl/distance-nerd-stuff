...
| D | **The Year Ring** | Routes on a clock face, January at 12, size proportional to the square root of miles, a typographic 40 at the center | Strong focal point and the most birthday-like, but it gives each route far less room than the grid does |
...
- trail running still has its own color, rather than merging into running;
